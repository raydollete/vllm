...
def init_attn_backend(
    ...
    for kv_cache_group_id, kv_cache_group_spec in enumerate(
        ...
        for layer_name in layer_names:
            ...
            # metadata builders, and on the backend's metadata group key (e.g.
            # per-window_left for FlashInfer) so layers whose metadata cannot
            # share one builder split as well.
